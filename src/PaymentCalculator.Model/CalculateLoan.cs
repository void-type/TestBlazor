...
namespace PaymentCalculator.Model
{
    public class CalculateLoan
    {
        ...
        {
            public Response(decimal totalPrincipal, decimal paymentPerPeriod, decimal totalInterestPaid, decimal totalEscrowPaid, decimal totalPaid, IReadOnlyList<AmortizationPeriod> schedule)
            {
                TotalPrincipal = totalPrincipal;
